...
@section('title', 'Meine Domains')
@section('page-title', 'Domains')
@section('page-subtitle', 'Ihre gehosteten Domains')

@section('page-actions')
    <a href="{{ route('panel.domains.create') }}"
            ...
            <tr class="hover:bg-gray-50 transition-colors">
                ...
                <td class="px-6 py-4 text-right">
                    <div class="flex items-center justify-end gap-2">
                        ...
                        <form method="POST" action="{{ route('panel.domains.destroy', $domain) }}"
                              x-data
            ...
            <tr>
                <td colspan="5" class="px-6 py-12 text-center">
                    <div class="flex flex-col items-center gap-3 text-gray-400">
                        ...
                        <a href="{{ route('panel.domains.create') }}" class="text-sm text-blue-600 hover:underline">Erste Domain hinzufügen</a>
                    </div>
                </td>
            </tr>
            @endforelse
