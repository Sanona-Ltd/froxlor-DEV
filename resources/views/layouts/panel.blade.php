...
<div x-data="{ sidebarOpen: true }" class="flex h-screen overflow-hidden bg-gray-50">
    ...
    <aside
        ...
        <nav class="flex-1 px-3 py-5 space-y-0.5 overflow-y-auto">
            ...
            <p class="px-3 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider">Mein Panel</p>

            <x-sidebar-item href="{{ route('panel.dashboard') }}" :active="request()->routeIs('panel.dashboard')">
                <x-slot:icon>
            ...
            <x-sidebar-item href="{{ route('panel.domains.index') }}" :active="request()->routeIs('panel.domains*')">
                <x-slot:icon>
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" class="w-5 h-5">
        ...
        <div class="border-t border-gray-200 p-3">
            <div x-data="{ open: false }" class="relative">
                <button @click="open = !open"
                    ...
                    <div class="w-8 h-8 rounded-full bg-gray-700 flex items-center justify-center text-white text-sm font-semibold flex-shrink-0">
    ...
    <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header class="h-16 bg-white border-b border-gray-200 flex items-center gap-4 px-6 flex-shrink-0">
            ...
            <div class="flex-1">
                <h1 class="text-base font-semibold text-gray-900">@yield('page-title', 'Übersicht')</h1>
